...
trainDataset = dset.ImageFolder(root=datasetDir + "/Entrenamiento/")
...
def training_fine_loc(room):
    trainDir = os.path.join(datasetDir, "Entrenamiento", room)
...
def validation_coarse_loc():
    valDir = os.path.join(datasetDir, "Validacion")

    with open(csvDir + '/ValidationCoarseLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
def validation_fine_loc(room):
    trainDir = os.path.join(datasetDir, "Validacion", room)

    with open(csvDir + '/ValidationFineLoc' + room + '.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Img", "Coord X", "Coord Y"])
...
def test_coarse_loc(ilum):
    ...
    with open(csvDir + '/Test' + ilum + 'CoarseLoc' + '.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(
            ["Img Test", "Idx Room"])
...
def test_fine_loc(ilum):
    ...
    with open(csvDir + '/Test' + ilum + 'FineLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(
...
def visual_model_fine_loc():
    testDir = datasetDir + "/Entrenamiento/"

    with open(csvDir + '/VisualModelFineLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(
...
def visual_model_global_loc():
    vmDir = datasetDir + "/Entrenamiento/"

    with open(csvDir + '/VisualModelGlobalLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(
            ["Img", "Coord X", "Coord Y"])
...
def validation_global_loc():
    ...
    with open(csvDir + '/ValidationGlobalLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Img", "Coord X", "Coord Y"])
...
def test_global_loc(ilum):
    ...
    with open(csvDir + '/Test' + ilum + 'GlobalLoc.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Img", "Coord X", "Coord Y"])
