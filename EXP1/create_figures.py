...
def display_confusion_matrix(actual, predicted, plt_name, rooms, loss, ilum):

    cm = confusion_matrix(actual, predicted)
    print(f"Confusion matrix: Test {ilum}")
    print(cm)
    ...
    plt.suptitle(f'Coarse localization', fontsize=24)
